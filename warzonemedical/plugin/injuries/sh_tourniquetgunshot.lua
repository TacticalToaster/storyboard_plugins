...
INJURY.name = "Tourniquet with Gunshot Wound";
INJURY.delay = 60;
INJURY.decay = 0;
INJURY.description = "A tourniquet wrapped around a limb. It's stopping a bleed from a gunshot wound currently.";
...
INJURY.icon = "nscp/status/effect_wound.png";
