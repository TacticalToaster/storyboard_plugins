...
INJURY.name = "Dismembered Forearm";
INJURY.delay = 60;
INJURY.decay = 0;
INJURY.description = "A large wound sits where your forearm would've been.";
INJURY.victim = "You feel a heavy ripping sensation where your forearm should be.";
INJURY.limit = 2;
INJURY.arm = 2;
...
function INJURY:GetAmputation(player, data)
	...
	return {["amp"] = lower.."arm", ["render"] = "ValveBiped.Bip01_"..upper.."_Forearm", ["norender"] = "ValveBiped.Bip01_"..upper.."_Forearm", ["ent"] = player};
end;
